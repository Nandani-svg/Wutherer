...
export default function AIPage() {
    ...
    return (
        <div className="space-y-5">
            ...
            decription="Configure conversational assistant personas, system instructions, and query cooldowns."
            action={
            ...
            {message && (
                <Alert variant={message.variant} dismissable onDismiss={() => setMessage(null)}>
                    {message.text}
                </Alert>
            )}
            ...
            <Card>
                <div className="flex items-center justify between p-1">
                    <div>
                        <h4 className="text-xs font-medium text-white">Enable AI Chat and Queries</h4>
                        <p className="text-[11px] text-slate-500 mt-0.5">Allow server members to converse with AI and use assistant tools</p>
                    </div>
                    <Switch
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Rate limit the interval between consecutive AI queries in seconds</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="max-w-xs space-y-1">
                        ...
                        <Input
                            ...
                            onChange={(e) => setConfig((p) => ({ ...p, cooldown: parseInt(e.target.value) }))}
                        />
                    </div>
                </CardContent>
            </Card>
